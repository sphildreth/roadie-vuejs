    ...
    <div v-if="loaded && !isPrivate">
      <v-container v-if="loaded" fluid grid-list-md>
        <v-layout row wrap>
          <v-flex xs12 sm7 md7>
            ...
            <v-layout row wrap>
              ...
              <v-flex xs4>
                <v-text-field v-bind:value="user.statusVerbose" label="User Status" readonly></v-text-field>
              </v-flex>             
            </v-layout>            
          </v-flex>
            ...
            <div class="stats-container">
              ...
              <v-tooltip bottom class="hidden-md-and-down">
                <v-chip slot="activator" color="secondary" text-color="white">
                  ...
                  {{ user.createdDate | formatTimeStamp(this.$store.getters.user) }}
                </v-chip>
              ...
              <v-tooltip bottom class="hidden-md-and-down">
                <v-chip slot="activator" color="secondary" text-color="white">
                  ...
                  {{ user.lastApiAccess | formatTimeStamp(this.$store.getters.user) }}
                </v-chip>
                <span>User Last API Access Date</span>
              </v-tooltip>         
              <v-tooltip bottom class="hidden-md-and-down">
                <v-chip slot="activator" color="secondary" text-color="white">
                  <v-avatar>
                  ...
                  {{ user.lastLogin | formatTimeStamp(this.$store.getters.user) }}
                </v-chip>
                <span>User Last Login Date</span>
              </v-tooltip>                                        
            </div>
          </v-flex>
        </v-layout>  
        <v-layout row wrap>
              ...
              <v-flex xs12 md6 v-if="user.statistics.mostPlayedTrack">
      ...
      <v-container fluid grid-list-md>
        <v-flex xs12>
          <v-card flat>
            <v-card-title class="title darken-3">User Rated Track Play History</v-card-title>
            <v-card-text>
